...
- UI: `app/index.tsx` is a single-screen flow with an add form, list view, and delete actions.
...
```
Actions: `addProduct`, `removeProduct`, `clearAll`. Persistence key: `vip-products`.
